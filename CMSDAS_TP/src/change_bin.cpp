...
void change_bin(int bin_iD, string condition, string MuonId, string quantity, bool IsMc, float* init_conditions, string hist_file = "Histograms.root")
{
    ...
    values = doFit(condition, MuonId, quantity, init_conditions, true, IsMc);
    ...
    get_efficiency(hist_all, hist_pass, quantity, IsMc);
}
