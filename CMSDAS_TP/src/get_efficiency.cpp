...
TEfficiency* get_efficiency(TH1F* ALL, TH1F* PASS, string quantity, bool IsMc)
{
    gSystem->cd("Efficiency_Result");
    gSystem->cd(quantity.c_str());
    
    string* file_name = new string[2];
    file_name[0] = "Efficiency_Run2018.root";
    file_name[1] = "Efficiency_MC.root";
    
    TFile* pFile = new TFile(file_name[IsMc].c_str(),"recreate");
